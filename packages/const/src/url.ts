...
export const OFFICIAL_URL = 'https://imoogle.ai';
export const OFFICIAL_PREVIEW_URL = 'https://imoogle.ai';
export const OFFICIAL_SITE = 'https://imoogle.ai';
...
export const PLUGINS_INDEX_URL = 'https://plugins.imoogle.ai';
...
export const BASE_PROVIDER_DOC_URL = 'https://imoogle.ai/docs/usage/providers';
